    ...
    <div class="cmr-spotlight-wrapper">
        <div class="cmr-spotlight-grid">
            ...
            <div class="cmr-spotlight-cell r1-c4">
                <img src="https://placehold.co/150x80?text=TOI" alt="TOI">
            </div>
            <div class="cmr-spotlight-cell r1-c5">
                <img src="https://placehold.co/150x80?text=CNBC" alt="CNBC">
            </div>

            <!-- Row 2 Logos -->
            <div class="cmr-spotlight-cell r2-c1">
                <img src="https://placehold.co/150x80?text=NDTV" alt="NDTV">
            </div>
            <div class="cmr-spotlight-cell r2-c2">
                <img src="https://placehold.co/150x80?text=abp" alt="ABP News">
            </div>
            <div class="cmr-spotlight-cell r2-c3">
                <img src="https://placehold.co/150x80?text=BBC" alt="BBC News">
            </div>
            <div class="cmr-spotlight-cell r2-c4">
                <img src="https://placehold.co/150x80?text=Aaj+Tak" alt="Aaj Tak">
            </div>
            <div class="cmr-spotlight-cell r2-c5">
                <img src="https://placehold.co/150x80?text=CNN" alt="CNN">
            </div>
            <div class="cmr-spotlight-cell r2-c6">
                <img src="https://placehold.co/150x80?text=India+Today" alt="India Today">
            </div>

            <!-- Row 3 Logos -->
            <div class="cmr-spotlight-cell r3-c2">
                <img src="https://placehold.co/150x80?text=Zee+News" alt="Zee News">
            </div>
            <div class="cmr-spotlight-cell r3-c3">
                <img src="https://placehold.co/150x80?text=R.Bharat" alt="Republic Bharat">
            </div>
