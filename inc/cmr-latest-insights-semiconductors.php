...
if ( ! function_exists( 'cmr_latest_insights_semiconductors_shortcode' ) ) {
    function cmr_latest_insights_semiconductors_shortcode( $atts ) {
        // Enqueue the specific CSS for this shortcode
        wp_enqueue_style( 'cmr-latest-insights' );

        $atts = shortcode_atts( array(
            'posts_per_page' => 4,
            'nav_title'      => 'Semiconductors',
            ...
            'category'       => 'semiconductors', // Dynamic category option
            'link_overview'  => '#top',
        ...
        ob_start();
        ?>
        <div class="cmr-latest-insights-section cmr-latest-insights-semiconductors">
...
add_shortcode( 'cmr_latest_insights_semiconductors', 'cmr_latest_insights_semiconductors_shortcode' );
