...
if ( ! function_exists( 'cmr_latest_insights_consumer_shortcode' ) ) {
    function cmr_latest_insights_consumer_shortcode( $atts ) {
        // Enqueue the specific CSS for this shortcode
        wp_enqueue_style( 'cmr-latest-insights' );

        $atts = shortcode_atts( array(
            'posts_per_page' => 4,
            'nav_title'      => 'Consumer Tech',
            ...
            'category'       => 'consumer-tech', // Dynamic category option
            'link_overview'  => '#top',
        ...
        ob_start();
        ?>
        <div class="cmr-latest-insights-section cmr-latest-insights-consumer">
...
add_shortcode( 'cmr_latest_insights_consumer', 'cmr_latest_insights_consumer_shortcode' );
