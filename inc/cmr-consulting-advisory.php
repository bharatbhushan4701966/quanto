<?php
/**
 * Shortcode for Consulting & Advisory Section
 */
...
if ( ! function_exists( 'cmr_consulting_advisory_shortcode' ) ) {
    function cmr_consulting_advisory_shortcode( $atts ) {
        wp_enqueue_style( 'cmr-industry-intelligence' );

        $atts = shortcode_atts( array(
            'posts_per_page'   => 6,
            'nav_title'        => 'Consulting & Advisory',
            'show_nav'         => 'true',
        ...
        <div class="cmr-industry-intel-section" id="overview">
            ...
            <?php if ( $insights_query->have_posts() ) : ?>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function fetchConsulting(page, isSearch = false) {
                        ...
                        fetch(ajaxurl, {
                            ...
                            body: 'action=cmr_load_more_consulting&page=' + page + '&search=' + encodeURIComponent(currentSearch) + '&category=' + encodeURIComponent(categorySlug) + '&base_url=' + encodeURIComponent(window.location.pathname)
                        })
                    ...
                    document.addEventListener('click', function(e) {
                        ...
                        if (link) {
                            ...
                            fetchConsulting(page, false); // append like Load More
                        }
                    });
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    allHeadings.forEach(function(h) {
                        ...
                        // "Trends" section
                        if (text.includes("Consulting & Advisory trends")) {
                            section.id = 'trends';
                        }
...
add_shortcode( 'cmr_consulting_advisory', 'cmr_consulting_advisory_shortcode' );
