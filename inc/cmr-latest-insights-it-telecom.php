...
if ( ! function_exists( 'cmr_latest_insights_it_telecom_shortcode' ) ) {
    function cmr_latest_insights_it_telecom_shortcode( $atts ) {
        ...
        ob_start();
        ?>
        <div class="cmr-latest-insights-section cmr-latest-insights-it-telecom">
...
add_shortcode( 'cmr_latest_insights_it_telecom', 'cmr_latest_insights_it_telecom_shortcode' );
