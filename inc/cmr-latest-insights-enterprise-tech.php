<?php
/**
 * Shortcode for Latest Insights Enterprise Tech Section
 */
...
if ( ! function_exists( 'cmr_latest_insights_enterprise_tech_shortcode' ) ) {
    function cmr_latest_insights_enterprise_tech_shortcode( $atts ) {
        // Enqueue the specific CSS for this shortcode
        wp_enqueue_style( 'cmr-latest-insights' );

        $atts = shortcode_atts( array(
            'posts_per_page' => 4,
            'nav_title'      => 'Enterprise Tech',
        ...
        ob_start();
        ?>
        <div class="cmr-latest-insights-section cmr-latest-insights-enterprise-tech">
            <div class="cmr-latest-nav-bar intel-nav-bar">
                ...
                <div class="intel-nav-links" style="display: flex; align-items: center;">
                    ...
                    <a href="<?php echo esc_attr( $atts['link_explore'] ); ?>">Explore Industry Intelligence</a>
            ...
            <div class="cmr-insights-filters-bar">
                <div class="cmr-insights-filters">
                    ...
                    $filters = ! empty( $atts['filters'] ) 
                        ...
                        : array( 'Cloud & SaaS', 'Cybersecurity', 'Digital Payments', 'E-Commerce' );
...
add_shortcode( 'cmr_latest_insights_enterprise_tech', 'cmr_latest_insights_enterprise_tech_shortcode' );
