...
add_action('wp_footer', function() {
    ...
    @media (max-width: 768px) {
        ...
        .e-con:has(> .download-btn),
        .e-con:has(> .talk-btn),
        .e-con:has(.download-btn),
        .e-con:has(.talk-btn),
        .elementor-element:has(> .download-btn),
        .elementor-element:has(> .talk-btn),
        ...
        .download-btn,
        .talk-btn,
        .elementor-widget-button.download-btn,
        .elementor-widget-button.talk-btn,
        .e-con:has(> .download-btn) > .elementor-widget-button,
        .e-con:has(> .talk-btn) > .elementor-widget-button,
        ...
        .download-btn .elementor-widget-container,
        .talk-btn .elementor-widget-container,
        .e-con:has(> .download-btn) .elementor-widget-container,
        .e-con:has(> .talk-btn) .elementor-widget-container,
        .e-con:has(> .elementor-widget-button + .elementor-widget-button) .elementor-widget-container,
        ...
        .e-con:has(> .download-btn) .elementor-button,
        .e-con:has(> .talk-btn) .elementor-button,
        ...
        .talk-btn .elementor-button-content-wrapper,
        .e-con:has(> .download-btn) .elementor-button-content-wrapper,
        .e-con:has(> .talk-btn) .elementor-button-content-wrapper,
        .e-con:has(> .elementor-widget-button + .elementor-widget-button) .elementor-button-content-wrapper,
