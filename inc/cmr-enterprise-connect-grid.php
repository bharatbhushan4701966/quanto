...
class Cmr_Enterprise_Connect_Grid_Widget extends Widget_Base {
    ...
    public function get_title() {
        ...
        return __( "CMR Enterprise Connect Grid", "quanto-core" );
    ...
    private function get_post_categories() {
        ...
        if (!is_wp_error($categories)) {
            foreach ( $categories as $category ) {
                $options[ $category->term_id ] = $category->name . ' (' . $category->taxonomy . ')';
            }
        }
        return $options;
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                "label" => __( "Select Category", "quanto-core" ),
                ...
                "description" => __("Select one or more categories to display latest posts from. Leave empty to use default enterprise posts.", "quanto-core"),
        ...
        $this->add_control(
            ...
            [
                ...
                "label" => __( "Link Featured", "quanto-core" ),
        ...
        $this->add_control(
            ...
            [
                ...
                "label" => __( "Link Latest", "quanto-core" ),
        ...
        $this->add_control(
            ...
            [
                ...
                "label" => __( "Link Market Updates", "quanto-core" ),
        ...
        $this->add_control(
            ...
            [
                ...
                "label" => __( "Link Reports", "quanto-core" ),
        ...
        $this->add_control(
            ...
            [
                ...
                "label" => __( "Link CMR in news", "quanto-core" ),
    ...
    protected function render() {
        ...
        if ( function_exists("cmr_get_unique_enterprise_post_ids") ) {
            ...
            $cat_ids = isset($settings['category_filter']) ? array_filter(array_map('intval', (array) $settings['category_filter'])) : [];
            ...
            if ( ! empty( $cat_ids ) ) {
                ...
                $args = array(
                    ...
                    "post__in"       => !empty($unique_ids) ? $unique_ids : [0],
                    "tax_query"      => $tax_query,
                    "posts_per_page" => 6,
                );
                $query = new \WP_Query( $args );

                $query->max_num_pages = $query->max_num_pages;

                $query->found_posts = $query->found_posts;

            } else if ( ! empty( $sliced_ids ) ) {
            ...
            // Fallback for Elementor preview if function is not available
        ...
        <div class="cmr-enterprisecgd-wrapper">
            ...
            <div class="cmr-enterprisecgd-top-nav-wrap" style="margin-bottom: 40px;">
                ...
                <div class="cmr-enterprisecgd-top-nav intel-nav-bar">
                    ...
                    <div class="intel-nav-links">
                        ...
                        <a href="<?php echo esc_attr($settings['link_featured']); ?>">Featured</a>

                        <a href="<?php echo esc_attr($settings['link_latest']); ?>">Latest</a>

                        <a href="<?php echo esc_attr($settings['link_market']); ?>">Market Updates</a>

                        <a href="<?php echo esc_attr($settings['link_reports']); ?>">Reports</a>

                        <a href="<?php echo esc_attr($settings['link_cmr_news']); ?>">CMR in news</a>
            ...
            <div class="cmr-enterprisecgd-grid" id="cmr-enterprisecgd-grid">
                ...
                if ( $query->have_posts() ) {
                    ...
                    echo '<p>No Enterprise Connect found.</p><!-- SQL: <?php echo esc_html(->request); ?> CATS: <?php print_r(); ?> -->';
                ...
                .then(response => {
                    ...
                    if (response.success) {
                        ...
                        if (!isLoadMore) {
                            ...
                            grid.innerHTML = response.data.html || '<p>No Enterprise Connect found.</p><!-- SQL: <?php echo esc_html(->request); ?> CATS: <?php print_r(); ?> -->';
...
$widgets_manager->register( new \Cmr_Enterprise_Connect_Grid_Widget() );
