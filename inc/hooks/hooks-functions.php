    ...
    if ( ! function_exists( 'quanto_print_homepage_tail_inline_styles' ) ) {
        function quanto_print_homepage_tail_inline_styles() {
            ...
            echo '<style id="quanto-homepage-tail-inline-css">
                ...
                .quanto-homepage-tail-sections .e-con{box-sizing:border-box;display:var(--display,flex)!important;flex-direction:var(--flex-direction,row);flex-wrap:var(--flex-wrap,nowrap);align-content:var(--align-content,normal);align-items:var(--align-items,stretch);justify-content:var(--justify-content,normal);grid-template-columns:var(--e-con-grid-template-columns);grid-template-rows:var(--e-con-grid-template-rows);grid-auto-flow:var(--grid-auto-flow,row);gap:var(--gap,0);max-width:min(100%,var(--width,100%));min-height:var(--min-height,initial);padding-block-start:var(--padding-block-start,0);padding-block-end:var(--padding-block-end,0);padding-inline-start:var(--padding-inline-start,0);padding-inline-end:var(--padding-inline-end,0);position:relative}
                .quanto-homepage-tail-sections > .elementor > .e-con, .quanto-homepage-tail-sections .e-con.e-parent,.quanto-homepage-tail-sections .e-con.e-con-full{width:var(--width,100%)}
                .quanto-homepage-tail-sections .e-con>.e-con-inner{box-sizing:border-box;display:var(--display,flex)!important;flex-direction:var(--flex-direction,row);flex-wrap:var(--flex-wrap,nowrap);align-items:var(--align-items,stretch);justify-content:var(--justify-content,normal);grid-template-columns:var(--e-con-grid-template-columns);grid-template-rows:var(--e-con-grid-template-rows);grid-auto-flow:var(--grid-auto-flow,row);gap:var(--gap,0);margin-left:auto;margin-right:auto;max-width:min(100%,var(--content-width,1320px));width:100%}
