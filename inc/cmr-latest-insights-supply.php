...
if ( ! function_exists( 'cmr_latest_insights_supply_shortcode' ) ) {
    function cmr_latest_insights_supply_shortcode( $atts ) {
        // Enqueue the specific CSS for this shortcode
        wp_enqueue_style( 'cmr-latest-insights' );

        $atts = shortcode_atts( array(
            'posts_per_page' => 4,
            'nav_title'      => 'Digital Supply Chain',
            ...
            'category'       => 'digital-supply-chain', // Dynamic category option
            'link_overview'  => '#top',
        ...
        ob_start();
        ?>
        <div class="cmr-latest-insights-section cmr-latest-insights-supply">
...
add_shortcode( 'cmr_latest_insights_supply', 'cmr_latest_insights_supply_shortcode' );
