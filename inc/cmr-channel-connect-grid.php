...
function cmr_channel_connect_grid_shortcode( $atts = array() ) {
    ob_start();
    ...
    <style>
        ...
        .cmr-channelcgd-search form:focus-within {
            border-color: #6A35FF;
        ...
        .cmr-channelcgd-search input::placeholder {
            color: #888;
        }
        ...
        .cmr-channelcgd-search-btn:hover {
            background: #5322d6;
