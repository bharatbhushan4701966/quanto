<?php
/**
 * Shortcode for Latest Insights MSME Section
 */
...
if ( ! function_exists( 'cmr_latest_insights_msme_shortcode' ) ) {
    function cmr_latest_insights_msme_shortcode( $atts ) {
        ...
        ob_start();
        ?>
        <div class="cmr-latest-insights-section cmr-latest-insights-msme">
...
add_shortcode( 'cmr_latest_insights_msme', 'cmr_latest_insights_msme_shortcode' );
