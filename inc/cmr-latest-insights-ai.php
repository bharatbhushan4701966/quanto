<?php
/**
 * Shortcode for Latest Insights AI Section
 */
...
if ( ! function_exists( 'cmr_latest_insights_ai_shortcode' ) ) {
    function cmr_latest_insights_ai_shortcode( $atts ) {
        ...
        ob_start();
        ?>
        <div class="cmr-latest-insights-section cmr-latest-insights-ai">
...
add_shortcode( 'cmr_latest_insights_ai', 'cmr_latest_insights_ai_shortcode' );
