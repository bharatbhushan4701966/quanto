...
// Register ACF Field Group for CMR Media Key Parts
add_action('acf/init', function() {
    if( function_exists('acf_add_local_field_group') ):
    acf_add_local_field_group(array(
        'key' => 'group_cmr_media_key_parts',
        'title' => 'Media Key Parts',
        'fields' => array(
            array(
                'key' => 'field_cmr_media_key_parts',
                'label' => 'Key Parts',
                'name' => 'key_parts',
                'type' => 'repeater',
                'instructions' => 'Add the timestamps and titles for key parts in the video.',
                'required' => 0,
                'conditional_logic' => 0,
                'wrapper' => array(
                    'width' => '',
                ...
                'max' => 0,
                'layout' => 'table',
                'button_label' => 'Add Key Part',
                'sub_fields' => array(
                    array(
                        'key' => 'field_cmr_media_kp_time',
                        'label' => 'Time',
                        'name' => 'time',
                        'type' => 'text',
                        'instructions' => 'Enter time as MM:SS (e.g., 00:05)',
                        'required' => 1,
                        'conditional_logic' => 0,
                        'wrapper' => array(
                            'width' => '30',
                    ...
                    array(
                        'key' => 'field_cmr_media_kp_title',
                        'label' => 'Title',
                        'name' => 'title',
                        'type' => 'text',
                        'instructions' => 'Enter the title of this part',
                        'required' => 1,
                        'conditional_logic' => 0,
                        'wrapper' => array(
                            'width' => '70',
